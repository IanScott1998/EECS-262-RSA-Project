...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7f3a6fb42020, const void *arg_0x7f3a6fb42320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7f3a6faba5e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f3a6f85d3a0), 
int (*key_eq_fn)(void *arg_0x7f3a6f85db70, void *arg_0x7f3a6f85de30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f3a6f64ac00, int arg_0x7f3a6f64ae80);
static double RandomUniform(void );
...
uint16_t Node__currentSeq[1000];
...
static inline void Node__CommandHandler__keyReq(uint16_t destination);
#line 208
...
# 16 "RSAP.nc"
public_key_class RSAP__pubKey[1000];
private_key_class RSAP__privKey[1000];
...
#line 378
{
  key = RSAP__rsa_modExp(key, RSAP__privKey[sim_node()].exponent, RSAP__privKey[sim_node()].modulus);
  return key;
}
...
#line 83
          ...
          sim_log_debug(112U, GENERAL_CHANNEL, "Node %d recieved encryption key request from node %d...\n", TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata));


          for (i = 0; i < 16; i++) {
              sim_log_debug(113U, GENERAL_CHANNEL, "payload[%d] = %d\n", i, __nesc_ntoh_uint8(myMsg->payload[i].nxdata));
            }
          ...
          sim_log_debug(114U, GENERAL_CHANNEL, "Recieved key: exponent = %lli, modulus = %lli\n", exponent, modulus);


          sharedKey = Node__RSAint__gen_shared_key();
          sim_log_debug(115U, GENERAL_CHANNEL, "The shared key is %llu\n", sharedKey);


          sharedKey = Node__RSAint__encrypt_shared_key(sharedKey, exponent, modulus);
          sim_log_debug(116U, GENERAL_CHANNEL, "The encrypted shared key is %llu\n", sharedKey);
          ...
          Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata), MAX_TTL, PROTOCOL_KEY_RECEIVE, Node__currentSeq[sim_node()], (uint8_t *)&payloadArr, PACKET_MAX_PAYLOAD_SIZE);
          Node__currentSeq[sim_node()]++;

          sim_log_debug(117U, GENERAL_CHANNEL, "message created... \n");
      ...
      if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_KEY_RECEIVE) {
          ...
          sim_log_debug(118U, GENERAL_CHANNEL, "Node %d recieved a shared key from node %d...\n", TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata));

          sharedKeyPtr = (int64_t *)&myMsg->payload[0];

          sharedKey = *sharedKeyPtr;

          sim_log_debug(119U, GENERAL_CHANNEL, "The encrypted shared key is %lli \n", sharedKey);

          sharedKey = Node__RSAint__decrypt_shared_key(sharedKey);

          sim_log_debug(120U, GENERAL_CHANNEL, "The decrypted shared key is %lli \n", sharedKey);
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f3a6f33ae30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f3a6f33ae30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f3a6f33ae30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 62
  ...
  sim_log_debug(210U, GENERAL_CHANNEL, "Generated number: %lu \n", r);
  return r;
}
...
{
  if (n <= 1 || n == 4) {
      sim_log_debug(205U, GENERAL_CHANNEL, "Input is not prime. (check 1)\n");
      return FALSE;
    }
  if (n <= 3) {
      sim_log_debug(206U, GENERAL_CHANNEL, "Input is prime.\n");
      return TRUE;
    }
  while (k > 0) {
      ...
      if (primeP__primeModule__gcd(n, a) != 1) {
          sim_log_debug(207U, GENERAL_CHANNEL, "Input is not prime. (check 2)\n");
          return FALSE;
        }

      if (primeP__primeModule__power(a, n - 1, n) != 1) {
          sim_log_debug(208U, GENERAL_CHANNEL, "Input is not prime. (check 3)\n");
          return FALSE;
        }
      k--;
    }
  sim_log_debug(209U, GENERAL_CHANNEL, "Input is prime.\n");
  return TRUE;
}
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f3a6f339a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f3a6f339a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f3a6f354c70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f3a6f354c70, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f3a6ecc3b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f3a6ecc3b60, addr, msg, len);
#line 80
...
#line 133
        {
          ...
          sim_log_debug(127U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(128U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(129U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f3a6ecc4940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f3a6ecc4940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f3a6ecc4940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 351
{
  if (RSAP__pubKey[sim_node()].modulus == (void *)0) {
      return 0;
    }
  return RSAP__pubKey[sim_node()].modulus;
}
...
#line 358
{
  if (RSAP__pubKey[sim_node()].exponent == (void *)0) {
      return 0;
    }
  return RSAP__pubKey[sim_node()].exponent;
}
...
#line 170
  ...
  sim_log_debug(123U, GENERAL_CHANNEL, "Node %d sending public key to node %d... \n", TOS_NODE_ID, destination);


  exponent = Node__RSAint__get_exponent();
  modulus = Node__RSAint__get_modulus();

  sim_log_debug(124U, GENERAL_CHANNEL, "Public key: e = %llu, m = %llu \n", exponent, modulus);
...
#line 189
      ...
      sim_log_debug(125U, GENERAL_CHANNEL, "Arr[%d] = %d\n", i, payloadArr[i]);
    }




  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, destination, MAX_TTL, PROTOCOL_KEY_REQUEST, Node__currentSeq[sim_node()], (uint8_t *)&payloadArr, PACKET_MAX_PAYLOAD_SIZE);
  Node__currentSeq[sim_node()]++;

  sim_log_debug(126U, GENERAL_CHANNEL, "message created... \n");
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      switch (commandID) {
          ...
          case CMD_KEY_REQ: 
            sim_log_debug(180U, COMMAND_CHANNEL, "Command Type: Key Request\n");
          CommandHandlerP__CommandHandler__keyReq(buff[0]);
          break;

          default: 
            sim_log_debug(181U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f3a6f51e020){
#line 75
  switch (arg_0x7f3a6f51e020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f3a6f51e020);
#line 75
      break;
#line 75
    }
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f3a6ed75950){
#line 83
  switch (arg_0x7f3a6ed75950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f3a6ed75950);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(156U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(155U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(152U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(153U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(145U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(135U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(140U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(141U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(142U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(147U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 162
  ...
  if (r < 1) {
      sim_log_debug(193U, GENERAL_CHANNEL, "not invertable\n");
      return 0;
    }
  if (t < 0) {
      return t + n;
...
#line 227
  ...
  sim_log_debug(197U, GENERAL_CHANNEL, "Key generation started...\n");
  ...
  RSAP__pubKey[sim_node()].modulus = n;
  RSAP__privKey[sim_node()].modulus = n;
...
#line 244
  ...
  sim_log_debug(198U, GENERAL_CHANNEL, "Encryption key generated...\n");
#line 267
  d = RSAP__inverse(e, phi_n);
  sim_log_debug(199U, GENERAL_CHANNEL, "Decryption key generated...\n");

  RSAP__pubKey[sim_node()].exponent = e;
  RSAP__privKey[sim_node()].exponent = d;

  sim_log_debug(200U, GENERAL_CHANNEL, "p: %lld, q: %lld, n or modulus: %lld, phi_n: %lld, e: %lld, d: %lld \n", p, q, n, phi_n, e, d);
}
...
#line 38
{
  ...
  sim_log_debug(108U, GENERAL_CHANNEL, "RSA connected = %d \n", testRSA);
...
#line 74
{
  ...
  while (foundPrime == FALSE) {
      sim_log_debug(211U, GENERAL_CHANNEL, "Checking if %llu is prime...\n", num);
      ...
      if (safety >= 300) {
          sim_log_debug(212U, GENERAL_CHANNEL, "safety triggered.\n");
          break;
        }
    }
  return num;
...
#line 285
  ...
  sim_log_debug(144U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(150U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(130U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(131U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(132U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(133U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(151U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(154U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(143U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__currentSeq"))
  {
    *addr = (uintptr_t)&Node__currentSeq[__nesc_mote];
    *size = sizeof(Node__currentSeq[__nesc_mote]);
    return 0;
  }
  ...
  /* Module RSAP */
  if (!strcmp(varname, "RSAP__pubKey"))
  {
    *addr = (uintptr_t)&RSAP__pubKey[__nesc_mote];
    *size = sizeof(RSAP__pubKey[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RSAP__privKey"))
  {
    *addr = (uintptr_t)&RSAP__privKey[__nesc_mote];
    *size = sizeof(RSAP__privKey[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  Node__currentSeq[__nesc_mote] = 0;
  ...
  /* Module RSAP */
  memset((void *)&RSAP__pubKey[__nesc_mote], 0, sizeof RSAP__pubKey[__nesc_mote]);
  memset((void *)&RSAP__privKey[__nesc_mote], 0, sizeof RSAP__privKey[__nesc_mote]);
